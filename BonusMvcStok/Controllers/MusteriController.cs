...
namespace BonusMvcStok.Controllers
{
    public class MusteriController : Controller
    {
        ...
        public ActionResult Index(int sayfa=1)
        {
            ...
            var musteriliste = db.tblmusteri.Where(x=> x.durum==true).ToList().ToPagedList(sayfa, 3);//her sayfa 3 tane değer göstelir--View sayfasında göster
        ...
        {
            if(!ModelState.IsValid)//validation doğruma hata verilse
            {
